    ...
    <div className="mx-auto flex min-h-screen max-w-5xl items-center px-4 py-10 sm:px-6 lg:px-8">
      <div className="grid w-full gap-8 rounded-3xl border border-border bg-card p-6 shadow-soft lg:grid-cols-2 lg:p-8 animate-fade-in">
        <div>
          ...
          <p className="mt-3 max-w-md text-text-secondary">Manage volunteer tasks, track hours, and connect with your neighborhood — all in one safe, trusted place.</p>
        </div>
        <div className="space-y-4">
          ...
          <p className="text-sm text-text-secondary">
            New here? <Link to="/signup/role" className="font-semibold text-primary hover:text-primary-dark transition">Create an account</Link>
          </p>
        </div>
      </div>
    </div>
