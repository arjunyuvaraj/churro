          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="rounded-lg border border-border px-4 py-3 text-sm font-semibold hover:bg-surface"
              >
                Bulk schedule
              </button>
              <button
            ...
            {selectedCalendarDate && (
              <div className="mt-4 rounded-2xl border border-border bg-white p-4">
                <div className="flex items-center justify-between mb-4">
                  <p className="font-semibold">Tasks on {selectedCalendarDate}</p>
                  <button
                    type="button"
            ...
            {tasksToDisplay.length > 0 ? (
              tasksToDisplay.map((task) => (
                <button
                  ...
                  className="rounded-2xl border border-border bg-white p-5 text-left transition hover:border-primary"
                >
